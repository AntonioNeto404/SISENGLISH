...
?>
<script>
// Validação Frontend para campos obrigatórios e números (exemplo para formulário de edição de matrículas)
function validarFormularioMatriculaEdit() {
...
document.getElementById('matricula-form')?.addEventListener('submit', function(e) {
    if (!validarFormularioMatriculaEdit()) e.preventDefault();
});
